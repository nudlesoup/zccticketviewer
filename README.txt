...
# Getting Started (Installation & Guide)
  ----------------
1. Just to run my Zendesk CLI Application (only access to Ameya's Tickets/Account), Download this file : Ameya-zendeskticketviewer.jar, from : https://github.com/nudlesoup/zccticketviewer or on drive: https://drive.google.com/file/d/1m1YK6iro54RyOz1c_Rtm9PGkTDq--KgC/view?usp=sharing 
...
3. To run any Zendesk CLI Application(access any user's Zendesk ticket account), Download this file : Testers-zendeskticketviewer.jar, from : https://github.com/nudlesoup/zccticketviewer, or on drive: https://drive.google.com/file/d/1_VfRDHcmOLwcqNjW_ADove0E0-Jm4NeZ/view?usp=sharing then go the the downloaded folder where the jar file is downloaded & run the following jar file with 3 arguments command(your personal Zendesk id, Zendesk password and subdomain) :  
